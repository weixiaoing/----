<template>
  <div>
    <myheader :title="'消息'">{{ chatList }}</myheader>
    <div class="news">
        ...
        <ul>
          <li>
            <div class="news-box" @click="enterComList">
              <div class="left">
                <div
                  style="background-color: rgba(48,210,4,0.93)"
                  class="tubiao"
                >
          ...
          <li v-if="chatList" v-for="(item, index) in chatList" :key="index">
            <div
              @click="enterChat(item.chatWith.username, item.chatWith._id)"
              class="news-box"
            >
              <div class="left">
                <div
                  :style="'backgroundImage:url(' + item.chatWith.avater + ' )'"
                  class="avater"
                ></div>
              </div>
              <div class="content">
                <div class="username">
                  ...
                  <span class="time" v-if="item.addTime">{{
                    item.addTime | chatTime
                  }}</span>
                </div>
